...
def run_home():
    ...
    data = {'members': ['Jeong-An Choi', 'Jeong-An Choi', 'Jae-Myoung Choi', 'Jae-Myoung Choi', 'Yong-Seok Kwon', 'Yong-Seok Kwon', 'Yong-Jun Yoon', 'Yong-Jun Yoon',
                        'Geon-Yong Lee', 'Geon-Yong Lee', 'Kyung-Cheol Lee', 'Kyung-Cheol Lee'],
            'Skills': ['Analysis, Planning', 'Analysis, Planning', 'Analysis, Preprocessing', 'Analysis, Preprocessing', 'Analysis, Dashboard', 'Analysis, Dashboard',
                       'Dashboard, PPT',  'Dashboard, PPT', 'Research,Dashboard', 'Research,Dashboard', '', ''],
            'Git or Blog': ['','', 'https://github.com/ChoiJMS2', 'https://james-choi88.tistory.com/', 'https://github.com/MaestroYongseok', 'https://blog.naver.com/maestrokwon78', 'https://github.com/leek1111', 'https://blog.naver.com/lgy2233', '']}
